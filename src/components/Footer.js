...
const Footer = () => {
  return (    
    <footer className="p-2 bg-white sm:p-6 dark:bg-gray-900 w-screen bg-gray-200 fixed bottom-0">            
        <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a className="hover:underline">AirBuenas™</a>. All Rights Reserved.
            </span>
            <span><p className='text-black'>Disclaimer: This is not the Official Tesla website</p></span>
